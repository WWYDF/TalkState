...
const mumble_version_t MUMBLE_PLUGIN_API_VERSION = { 1, 0, 0 };
...
struct MumbleAPI_v_1_0_x {
	...
	mumble_error_t(PLUGIN_CALLING_CONVENTION* requestTalkingState)(
		mumble_plugin_id_t callerID, mumble_talking_state_t talkingState);
